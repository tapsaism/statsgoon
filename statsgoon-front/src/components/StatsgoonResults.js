  ...
  getTabPanes = () => {
    return (
      [
        ...
        { menuItem: 'Total points', render: () => <Tab.Pane attached={false}><MultiLineChart chartData={this.props.dailyStats} interpolation='stepAfter' measure='points_total'/></Tab.Pane> },
        { menuItem: 'Avg points', render: () => <Tab.Pane attached={false}><MultiLineChart chartData={this.props.dailyStats} interpolation='basis' measure='points_avg'/></Tab.Pane> },
        { menuItem: 'Daily points', render: () => <Tab.Pane attached={false}><MultipleLineCharts chartData={this.props.dailyStats} measure='points_daily'/></Tab.Pane> },
        { menuItem: 'Value', render: () => <Tab.Pane attached={false}><MultiLineChart chartData={this.props.dailyStats} interpolation='basis' measure='player_value'/></Tab.Pane> },
      ]
    )
  }
